...
namespace BatRecordingManager
{
    ...
    public partial class BatDetailControl : UserControl
    {
        ...
        private ObservableCollection<Call> CallList { get; set; } = new ObservableCollection<Call>();
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        {
            ...
            set
            {
                ...
                if (BatCallControl != null && CallList != null)
                {
                    ...
                    PrevCallButton.IsEnabled = value >= 1;
                    NextCallButton.IsEnabled = value < CallList.Count - 1;
                }
                else
                {
        ...
        public Bat selectedBat
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    {
                        //CallList.Clear();
                        CallList=new ObservableCollection<Call>(DBAccess.GetCallsForBat(value));
