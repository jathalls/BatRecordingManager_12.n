...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    internal class FileProcessor
    {
        ...
        {
            var listOfsegmentAndBatLists = new ObservableCollection<SegmentAndBatList>();
            var outputString = "";
        ...
        private static string ProcessText(string[] allLines, TimeSpan duration,
            ref ObservableCollection<SegmentAndBatList> listOfsegmentAndBatLists, Mode mode,
            ref Dictionary<string, BatStats> batsFound, string autoID)
        {
            var outputString = "";
            var linesToMerge = new ObservableCollection<string>();
