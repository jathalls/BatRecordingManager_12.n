...
namespace BatRecordingManager
{
    ...
    public class FrequencyData
    {
        ...
        public FrequencyData(int aggregationPeriod, Bat bat, ObservableCollection<int> occurrencesPerPeriod)
        {
            ...
            this.bat = bat;
            OccurrencesPerPeriod = occurrencesPerPeriod ?? new ObservableCollection<int>();// set internal array to that provided or an empty one
        ...
        /// </summary>
        public ObservableCollection<int> OccurrencesPerPeriod { get; set; } = new ObservableCollection<int>();
    ...
    public partial class ReportMainWindow : Window
    {
        ...
        public ObservableCollection<ReportData> reportDataByBatList { get; set; } =
            new ObservableCollection<ReportData>();

        /// <summary>
        /// </summary>
        public ObservableCollection<FrequencyData> reportDataByFrequencyList { get; set; } =
            new ObservableCollection<FrequencyData>();

        public ObservableCollection<RecordingReportData> reportDataByRecordingList { get; set; } =
            new ObservableCollection<RecordingReportData>();

        public ObservableCollection<ReportData> reportDataBySessionList { get; set; } =
            new ObservableCollection<ReportData>();

        /// <summary>
        ///
        /// </summary>
        public ObservableCollection<ReportData> reportSummaryList { get; set; } = new ObservableCollection<ReportData>();
            ...
            List<Recording> reportRecordingList)
        {
            ...
            {
                //ReportBatStatsList = new ObservableCollection<BatStatistics>();
                ReportBatStatsList=new ObservableCollection<BatStatistics>(reportBatList.Where(rbl => rbl != null).Distinct());

            }

            if (reportSessionList != null)
            {
                //ReportSessionList = new ObservableCollection<RecordingSession>();
                ReportSessionList=new ObservableCollection<RecordingSession>(reportSessionList.Where(rsl => rsl != null).Distinct());
            ...
            {
                //ReportRecordingList = new ObservableCollection<Recording>();
                ReportRecordingList=new ObservableCollection<Recording>(reportRecordingList.Where(rrl => rrl != null).Distinct());
        ...
        private ObservableCollection<BatStatistics> ReportBatStatsList { get; set; } =
                                                                    new ObservableCollection<BatStatistics>();

        private ObservableCollection<Recording> ReportRecordingList { get; set; } =
            new ObservableCollection<Recording>();

        private ObservableCollection<RecordingSession> ReportSessionList { get; set; } =
