...
namespace BatRecordingManager
{
    ...
    public class FileBrowser
    {
        ...
        public ObservableCollection<string> WavFileNames = new ObservableCollection<string>();
        ...
        /// </value>
        public string ExistingLogFileName { get; set; } = "";
        ...
        ///     The text file names.
        /// </value>
        public ObservableCollection<string> TextFileNames { get; set; } = new ObservableCollection<string>();
        ...
        public string WorkingFolder
        {
            ...
            set
            {
                ...
                if (string.IsNullOrWhiteSpace(_workingFolder) || !Directory.Exists(_workingFolder))
                    TextFileNames.Clear();
            }
        }
        ...
        /// <summary>
        /// Shows a dialog for the user to select a folder containing .wav files by default, or
        /// with a txt or zc file extension if explicitly requested.
        /// Returns null if no folder is selected.  Does not check the folder contents.
        /// </summary>
        ...
        {
            var wavFolders = new ObservableCollection<string>();
