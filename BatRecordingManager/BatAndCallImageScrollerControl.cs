...
namespace BatRecordingManager
{
    ...
    public class BatAndCallImageScrollerControl : ImageScrollerControl
    {
        ...
        /// </summary>
        public ObservableCollection<StoredImage> BatImages { get; set; } = new ObservableCollection<StoredImage>();
        ...
        /// </summary>
        public ObservableCollection<StoredImage> CallImageList { get; set; } =
            new ObservableCollection<StoredImage>();

        /// <summary>
        ///     The list of defined call types for this bat
        /// </summary>
        public ObservableCollection<Call> CallList { get; } = new ObservableCollection<Call>();
        ...
        /// </summary>
        public ObservableCollection<ObservableCollection<StoredImage>> ListofCallImageLists { get; } =
            new ObservableCollection<ObservableCollection<StoredImage>>();
        ...
        public int SelectedCallIndex
        {
            ...
            set
            {
                ...
                if (!ImageScrollerDisplaysBatImages)
                {
                    ...
                    CallImageList = new ObservableCollection<StoredImage>(imageList);
                    ...
                    {
                        ListofCallImageLists[_selectedCallIndex] = new ObservableCollection<StoredImage>(CallImageList);

                    }
                    else if (_selectedCallIndex >= 0) // therefore index >=Count
                    {
                        var boc = new ObservableCollection<StoredImage>(CallImageList);
        ...
        public new void Update()
        {
            ...
            if (ImageScrollerDisplaysBatImages)
            {
                BatImages = new ObservableCollection<StoredImage>(imageList);
            ...
            else
            {
                if (SelectedCallIndex >= 0 && SelectedCallIndex < ListofCallImageLists.Count)
                {
                    ...
                    ListofCallImageLists[SelectedCallIndex] = new ObservableCollection<StoredImage>(imageList);
                    Title = "Call Images";
        ...
        /// </summary>
        /// <returns></returns>
        internal ObservableCollection<StoredImage> GetCurrentImageList()
        {
            if (SelectedCallIndex >= 0 && SelectedCallIndex < ListofCallImageLists.Count)
