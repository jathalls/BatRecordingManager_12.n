...
namespace BatRecordingManager
{
	...
	*/
    ...
    public partial class RecordingForm : Window
    {
        ...
        private ObservableCollection<bool> _modifiedFlag = new ObservableCollection<bool>();
        ...
        private bool AddEditSegment(LabelledSegment segmentToEdit)
        {
            ...
            if (segmentForm.ShowDialog() ?? false)
                if (segmentForm.DialogResult ?? false)
                {
                    ...
                    RecordingFormImageScroller.ListofCallImageLists.Add(new ObservableCollection<StoredImage>());
        ...
        private void AddSegmentButton_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            {
                //RecordingFormImageScroller.CallListofImageLists.Add(new ObservableCollection<StoredImage>());
            }
        ...
        public static readonly DependencyProperty LabelledSegmentsListProperty =
            DependencyProperty.Register(nameof(LabelledSegmentsList), typeof(ObservableCollection<LabelledSegment>),
                typeof(RecordingForm),
                new FrameworkPropertyMetadata(new ObservableCollection<LabelledSegment>()));
        ...
        {
            get => (ObservableCollection<LabelledSegment>)GetValue(LabelledSegmentsListProperty);
            set
            {
                SetValue(LabelledSegmentsListProperty, value);
                _modifiedFlag = new ObservableCollection<bool>();
