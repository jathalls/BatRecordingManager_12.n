...
namespace BatRecordingManager
{
    ...
    public partial class BatEditor : Window
    {
        ...
        /// </summary>
        public static  DependencyProperty BatListProperty =
            DependencyProperty.Register(nameof(BatList), typeof(ObservableCollection<Bat>), typeof(BatEditor),
                new PropertyMetadata(new ObservableCollection<Bat>()));
        ...
        public ObservableCollection<Bat> BatList
        {
            get
            {
                return ((ObservableCollection<Bat>)GetValue(BatListProperty));
            }
            set
            {
                SetValue(BatListProperty, new ObservableCollection<Bat>());
            }
        } 
        ...
        private void AddRecordButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(errString))
            {
                ...
                //BatList.Clear();
                BatList=new ObservableCollection<Bat>(sorted);
                BatNameListBox.ItemsSource = BatList;
        ...
        private void LoadDataToBatList()
        {
            ...
            //BatList.Clear();
            BatList=new ObservableCollection<Bat>(DBAccess.GetSortedBatList());
        }
