...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        public static RecordingSession FillSessionFromHeader(string headerFile, string sessionTag,
            ObservableCollection<string> wavFileFolders = null)
        {
        ...
        internal static RecordingSession CreateSession(string folderPath, string sessionTag = "", GpxHandler gpxHandler = null)
        {
            ...
            var folderList = new ObservableCollection<string> { folderPath };
        ...
        internal static RecordingSession PopulateSession2(RecordingSession newSession, string headerFile,
                    string sessionTag, ObservableCollection<string> wavFileFolders)
        {
            //bool noHeader = false;
...

            {
                if (!string.IsNullOrWhiteSpace(headerFile))
                {
                    ...
                    wavFileFolders = new ObservableCollection<string>();
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        /// <returns></returns>
        private static string GetBestMatch(ObservableCollection<string> referenceList, string[] targetList)
        {
            string bestSoFar = "";
