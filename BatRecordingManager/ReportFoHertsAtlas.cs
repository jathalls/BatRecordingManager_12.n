...
namespace BatRecordingManager
{
    internal class ReportFoHertsAtlas : ReportMaster
    {
        ...
        /// </summary>
        public ObservableCollection<RecordingReportData> reportDataList { get; set; } =
        ...
        // </summary>
        //public ObservableCollection<ReportData> reportDataBySessionList { get; set; } = new ObservableCollection<ReportData>();
            ...
            ObservableCollection<Recording> reportRecordingList)
        {
            ...
            {
                //var tmpList = new ObservableCollection<RecordingReportData>();
                var tmpList = new ObservableCollection<RecordingReportData>(reportDataList.OrderBy(recrepdata => recrepdata.recording.RecordingName));
        ...
        private void CreateTable()
        {
            ...
            ReportDataGrid.Columns.Add(column);
            column = CreateColumn("Date", "recording.RecordingSession.SessionDate", Visibility.Visible,
                "ShortDate_Converter");
            ReportDataGrid.Columns.Add(column);
            ...
            ReportDataGrid.Columns.Add(column);
            column = CreateColumn("Status", "status", Visibility.Visible, "");
            ReportDataGrid.Columns.Add(column);
            column = CreateColumn("Comment", "recording.RecordingStartTime", Visibility.Visible, "ShortTime_Converter");

            ReportDataGrid.Columns.Add(column);
            column = CreateColumn("Observer", "session.Operator", Visibility.Visible, "");
            ReportDataGrid.Columns.Add(column);
        }
    }
}