...
namespace BatRecordingManager
{
    ...
    public partial class EditBatForm : Window
    {
        ...
        /// </summary>
        public ObservableCollection<Call> CallList { get; set; } = new ObservableCollection<Call>();

        //public ObservableCollection<BitmapSource> ImageList { get; } = new ObservableCollection<BitmapSource>();
        ...
        public Bat NewBat
        {
            ...
            set
            {
                ...
                if (BatCallControl != null)
                {
                    ...
                    //if (rawCallList != null)
                    //{
                    var calls = DBAccess.GetCallsForBat(value);
                    if (calls == null || !calls.Any())
                    {
                        CallList = new ObservableCollection<Call>();
                    }
                    else
                    {
                        CallList = new ObservableCollection<Call>(calls);
                    }
                    //}
