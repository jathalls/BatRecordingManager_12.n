...
namespace BatRecordingManager
{
    ...
    {
        public ObservableCollection<ReportData> reportDataList { get; set; } =
            ...
            ObservableCollection<Recording> reportRecordingList)
        {
            ...
            //var tmp = new ObservableCollection<ReportData>();
            var tmp=new ObservableCollection<ReportData>(reportDataList.Distinct());
            reportDataList = tmp;
