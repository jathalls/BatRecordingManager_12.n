...
namespace BatRecordingManager
{
    ...
    public partial class FolderSelectionDialog : Window
    {
        ...
        public static readonly DependencyProperty FolderListProperty =
            DependencyProperty.Register(nameof(FolderList), typeof(ObservableCollection<string>),
        ...
        {
            get => (ObservableCollection<string>)GetValue(FolderListProperty);
            set
            {
