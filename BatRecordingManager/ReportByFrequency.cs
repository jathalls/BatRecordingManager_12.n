...
namespace BatRecordingManager
{
    ...
    public class ReportByFrequency : ReportMaster
    {
        ...
        /// </summary>
        public ObservableCollection<FrequencyData> reportDataList { get; set; } =
        ...
        public override void SetData(ObservableCollection<BatStatistics> reportBatStatsList,
            ...
            ObservableCollection<Recording> reportRecordingList)
        {
            try
            {
                ...
                if (reportDataList == null) reportDataList = new ObservableCollection<FrequencyData>();
                reportDataList.Clear();
                var binding = new Binding("reportDataList");
                //binding.Source = new FrequencyData(10, new Bat(), new ObservableCollection<int>());
            ...
            try
            {
                ...
                foreach(var bat in bats) batList.Add(bat);
                ...
                foreach (var bat in batList)
                {
                    ...
                    foreach (var recordingSession in reportSessionList)
                    {
                        bool sessionHasBat = (
                            ...
                            where !(sessbatLnk.ByAutoID ?? false) && sessbatLnk.BatID == bat.Id
        ...
        private readonly ObservableCollection<FrequencyData> OccurrencesPerPeriod =
            new ObservableCollection<FrequencyData>();

        private int _aggregationPeriod = 10;
        private int _tableStartTimeInMinutesFromMidnight = 720;
        private ObservableCollection<Bat> batList { get; set; } = new ObservableCollection<Bat>();
        ...
        private FrequencyData GetFrequencyData(Bat bat, ObservableCollection<RecordingSession> reportSessionList, ObservableCollection<Recording> reportRecordingList)
        {
            FrequencyData fd = FrequencyData.CreateEmpty(AggregationPeriodInMinutes, bat);
            ...
            try
            {
                ...
                //fd.OccurrencesPerPeriod = new ObservableCollection<int>();
                fd.OccurrencesPerPeriod=new ObservableCollection<int>(newOccurrencesPerPeriod);
        ...
        private FrequencyData GetFrequencyData(Bat bat, RecordingSession recordingSession, ObservableCollection<Recording> reportRecordingList)
        {
            FrequencyData fd = FrequencyData.CreateEmpty(AggregationPeriodInMinutes, bat);
            var newOccurrencesPerPeriod = new int[144];
            try
