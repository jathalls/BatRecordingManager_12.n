...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        public void setLocation(Location? oldLocation)
        {
            MapControl.ThisMap.Center = oldLocation;
            
        }

        public void SetPushPin(Location? oldLocation)
        {
            MapControl.AddPushPin(oldLocation);
        }

        public void SetPushPin(Location? location,string text,int ordinate=-1)
        {
            MapControl.AddPushPin(location, text, ordinate);
        }
