...
namespace BatPassAnalysisFW
{
    ...
    public partial class Settings : Window, INotifyPropertyChanged
    {
        ...
        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            utSettings.AnalysisFW.envelopeThresholdFactor = (float)EnvelopeThreshold;
            utSettings.AnalysisFW.envelopeLeadInMS= (float)EnvelopeLeadin;
            utSettings.AnalysisFW.envelopeLeadOutMS= (float)EnvelopeLeadout;
            utSettings.AnalysisFW.spectrumThresholdFactor= (float)SpectrumThreshold;
            utSettings.AnalysisFW.spectrumLeadInsamples= (int)SpectrumLeadin;
            utSettings.AnalysisFW.spectrumLeadOutSample= (int)SpectrumLeadout;
            utSettings.AnalysisFW.fftSize = FftSize;
            utSettings.AnalysisFW.enableFilter = EnableFilter;
            if (Directory.Exists(DirectoryPath))
            {
                utSettings.AnalysisFW.initialDirectory = DirectoryPath;
            }
        ...
        public string SelectFolder()
        {
            ...
            string defaultFolder = UTSettings.getSettings().AnalysisFW.initialDirectory;
