    ...
    public partial class AnalysisTableA : UserControl
    {
        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            using (new WaitCursor())
            {
                ...
                utSettings.AnalysisFW.envelopeThresholdFactor = (float)tableData.thresholdFactor;
                utSettings.AnalysisFW.spectrumThresholdFactor = (float)tableData.spectrumFactor;
